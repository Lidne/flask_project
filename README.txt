...
Добавлять аватары нужно на сайте https://ru.gravatar.com/, надо зарегестрироваться с почтой,
указанной при регистрации на нашем сайте и добавить автар.
Это помогает отличать системных пользователей от настоящих.